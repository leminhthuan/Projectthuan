...
extern "C"
{
	...
	QCAR::DataSet* dataSetvmio_vuforial_dev    = 0;
	...
	const int vmio_vuforial_dev_ID = 2;
	int selectedDataset = STONES_AND_CHIPS_DATASET_ID;

	// Object to receive update callbacks from QCAR SDK
	class PfinderTargets_UpdateCallback : public QCAR::UpdateCallback
	{
	...
	PfinderTargets_UpdateCallback updateCallback;

	JNIEXPORT void JNICALL
	Java_com_miosys_finder_ui_PfinderTargets_setActivityPortraitMode(JNIEnv *, jobject, jboolean isPortrait)
	{
		 LOG("Java_com_miosys_finder_ui_PfinderTargets_setActivityPortraitMode");
	     isActivityInPortraitMode = isPortrait;
	}


	JNIEXPORT void JNICALL
	Java_com_miosys_finder_ui_PfinderTargets_switchDatasetAsap(JNIEnv *, jobject, jint datasetId)
	{
	...
	Java_com_miosys_finder_ui_PfinderTargets_initTracker(JNIEnv *, jobject)
	{
	    LOG("Java_com_miosys_finder_ui_PfinderTargets_initTracker");
	...
	JNIEXPORT void JNICALL
	Java_com_miosys_finder_ui_PfinderTargets_deinitTracker(JNIEnv *, jobject)
	{
	    LOG("Java_com_miosys_finder_ui_PfinderTargets_deinitTracker");
	...
	JNIEXPORT void JNICALL
	Java_com_miosys_finder_ui_PfinderTargets_onQCARInitializedNative(JNIEnv *, jobject)
	{
...
//				}
	...
	JNIEXPORT void JNICALL
	Java_com_miosys_finder_ui_PfinderTargets_initApplicationNative(JNIEnv* env, jobject obj, jint width, jint height)
	{
	    LOG("Java_com_miosys_finder_ui_PfinderTargets_initApplicationNative");
	    ...
	    jmethodID getTextureMethodID = env->GetMethodID(activityClass,
	        "getTexture", "(I)Lcom/miosys/finder/ui/Texture;");
	    ...
	    LOG("Java_com_miosys_finder_ui_PfinderTargets_initApplicationNative finished");
	}

	JNIEXPORT void JNICALL
	Java_com_miosys_finder_ui_PfinderTargets_deinitApplicationNative(
	                                                        JNIEnv* env, jobject obj)
	{
	    LOG("Java_com_miosys_finder_ui_PfinderTargets_deinitApplicationNative");
...
//	        LOG("IMAGE TARGETS : enabled torch");
	...
	JNIEXPORT void JNICALL
	Java_com_miosys_finder_ui_PfinderTargets_setProjectionMatrix(JNIEnv *, jobject)
	{
	    LOG("Java_com_miosys_finder_ui_PfinderTargets_setProjectionMatrix");
	...
	Java_com_miosys_finder_ui_PfinderTargets_activateFlash(JNIEnv*, jobject, jboolean flash)
	{
	    return QCAR::CameraDevice::getInstance().setFlashTorchMode((flash==JNI_TRUE)) ? JNI_TRUE : JNI_FALSE;
	}

	JNIEXPORT jboolean JNICALL
	Java_com_miosys_finder_ui_PfinderTargets_autofocus(JNIEnv*, jobject)
	{
	    return QCAR::CameraDevice::getInstance().setFocusMode(QCAR::CameraDevice::FOCUS_MODE_TRIGGERAUTO) ? JNI_TRUE : JNI_FALSE;
	}

	JNIEXPORT jboolean JNICALL
	Java_com_miosys_finder_ui_PfinderTargets_setFocusMode(JNIEnv*, jobject, jint mode)
	{
	    int qcarFocusMode;
	...
	JNIEXPORT jboolean JNICALL
	Java_com_miosys_finder_ui_PfinderTargets_stopExtendedTracking(JNIEnv*, jobject)
	{
	    QCAR::TrackerManager& trackerManager = QCAR::TrackerManager::getInstance();
	    QCAR::ImageTracker* imageTracker = static_cast<QCAR::ImageTracker*>(
	          trackerManager.getTracker(QCAR::ImageTracker::getClassType()));
	...
	JNIEXPORT void JNICALL
	Java_com_miosys_finder_ui_ImageTargetsRenderer_initRendering(JNIEnv* env, jobject obj)
	{
	    LOG("Java_com_miosys_finder_ui_ImageTargetsRenderer_initRendering");
	...
	JNIEXPORT void JNICALL
	Java_com_miosys_finder_ui_ImageTargetsRenderer_updateRendering(JNIEnv* env, jobject obj, jint width, jint height)
	{
	    LOG("Java_com_miosys_finder_ui_ImageTargetsRenderer_updateRendering");
	...
	/*function for test android Jni*/
	JNIEXPORT jstring JNICALL
	Java_com_miosys_finder_ui_PfinderTargets_stringFromJNI(JNIEnv *env, jobject obj)
	{
