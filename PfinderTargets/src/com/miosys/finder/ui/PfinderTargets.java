...
import com.miosys.finder.SampleAppMenu.SampleAppMenu;
import com.miosys.finder.SampleAppMenu.SampleAppMenuGroup;
import com.miosys.finder.SampleAppMenu.SampleAppMenuInterface;
import com.miosys.finder.listview.PFinder_ListView;
import com.miosys.finder.utils.DebugLog;
import com.qualcomm.QCAR.QCAR;

public class PfinderTargets extends Activity implements SampleAppMenuInterface{
    ...
    private static final String NATIVE_LIB_SAMPLE = "PfinderTargets";
    ...
    private Object mShutdownLock = new Object();
     ...
     {
         private final WeakReference<PfinderTargets> mFinderTargets;
         
         
         LoadingDialogHandler(PfinderTargets imageFinderTargets)
         {
        	 mFinderTargets = new WeakReference<PfinderTargets>(imageFinderTargets);
         }
         
         
         public void handleMessage(Message msg)
         {
        	 PfinderTargets imageMainActivity = mFinderTargets.get();
             if (imageMainActivity == null)
             {
                 return;
             }
             ...
             {
            	 imageMainActivity.mLoadingDialogContainer
                     .setVisibility(View.VISIBLE);
                 
             } else if (msg.what == HIDE_LOADING_DIALOG)
             {
            	 imageMainActivity.mLoadingDialogContainer.setVisibility(View.GONE);
             }
         }
     }
     ...
     private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
     {
         ...
         protected Boolean doInBackground(Void... params)
         {
             ...
             {
                 QCAR.setInitParameters(PfinderTargets.this, mVuforiaFlags);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pfinder);
    ...
    /** switch to listview message after object detected*/
    public void switchToListView(String targetName) {
    	stopCamera();
    	String value = targetName;
    	Log.i("PfinderTargets", "Found target: " + targetName);
    	Intent intent = new Intent(PfinderTargets.this, PFinder_ListView.class);
    	intent.putExtra("targetName", value);    
    ...
    private synchronized void updateApplicationStatus(int appStatus)
    {
        ...
        switch (mAppStatus)
        {
            ...
            case APPSTATUS_INITED:
                ...
                cameraPreview.addView(mGlView, new LayoutParams(LayoutParams.MATCH_PARENT,
...
//                    LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
            ...
            case APPSTATUS_CAMERA_RUNNING:
                ...
                {
                    mSampleAppMenu = new SampleAppMenu(this, this, "Pfinder Targets",
    ...
    private void initApplicationAR()
    {
        ...
        mRenderer.mPfinderTargets = this;
        ...
        cameraPreview.addView(mUILayout,new LayoutParams(LayoutParams.MATCH_PARENT,
        			LayoutParams.MATCH_PARENT));
//        addContentView(mUILayout, new LayoutParams(LayoutParams.WRAP_CONTENT,
